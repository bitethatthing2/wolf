  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta httpEquiv="Content-Security-Policy" content="default-src 'self'; connect-src 'self' https://*.instagram.com https://*.elfsight.com https://*.google.com https://api.instagram.com https://*.googleapis.com; img-src 'self' https://static.elfsight.com https://*.instagram.com https://*.google.com https://*.googleapis.com https://*.gstatic.com data:; style-src 'self' 'unsafe-inline' https://static.elfsight.com https://fonts.googleapis.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://static.elfsight.com https://*.google.com https://*.gstatic.com; frame-src 'self' https://*.google.com https://*.youtube.com https://*.instagram.com https://maps.google.com; font-src 'self' https://fonts.gstatic.com data:;" />
